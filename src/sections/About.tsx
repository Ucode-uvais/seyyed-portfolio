...
import myMemoji from "@/assets/images/memoji_uvais.png";
  ...
  return (
    <div className="py-20 lg:py-28">
      <div className="container">
        <SectionHeader
          eyebrow="About Me"
          title="A Glimpse Into My Domain"
        ...
        <div className="mt-20 flex flex-col gap-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
            ...
            <Card className="h-[320px]  md:col-span-3 lg:col-span-2">
              <CardHeader
                title="My Toolbox"
                description=" Explore the technologies and tools i use to craft exceptonal
              digital experiences."
                className=""
              />
              <ToolboxItems
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full after:content[''] after:absolute after:inset-0 after:outline after:outline-2 after:outline-offset-2 after:rounded-full after:outline-gray-950/30">
                ...
                <Image src={myMemoji} alt="my emoji" className="size-20" />
              </div>
            </Card>
          </div>
        </div>
